...
まず[箱の中央に文字を重ねる練習](../../02_作れるようになる/箱の中央に文字を重ねる.md)で、箱を広げる指定と中身を中央へ置く指定を分けて試す。

`inset: 0`で全面になるには、幅・高さ・余白などの条件がある。imgのサイズ計算も異なるため、広がらない場合は[条件の違い](../../03_深く分かる・詰まった時に調べる/insetで広がる条件を調べる.md)を確認する。
