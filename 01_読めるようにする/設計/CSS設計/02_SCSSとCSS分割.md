...
ここでの後勝ちは、出所、`!important`、カスケードレイヤーなど他の条件が同じ場合を指す。カスケード全体とDevToolsでの確認は [CSSカスケードとDevToolsの見方](../../HTML・CSS/15_CSSカスケードとDevToolsの見方.md) で扱う。
