...
- 実務判断で迷う内容は、必要に応じて `02_検証` 側へ運用ルールとして降ろす
...
- 反映:
  - [01_ケース_Blogカード画像_レンダリング挙動](../../02_検証/portfolio/01/01_ケース_Blogカード画像_レンダリング挙動.md)
...
- 反映:
  - [00_HTML・CSS整理マップ](./00_HTML・CSS整理マップ.md)
    - `01〜08`（基礎概念）と `02_検証`（個別検証）の運用モード分離を明記
    - ケース検証運用ファイルへの導線追加
  - [00_ケース検証運用](../../02_検証/00_ケース検証運用.md)
    - 命名ルール、置き場、記録テンプレを追加

## 追記ログ（2026-05-03-3）

- 要望: `02_検証` フォルダ内を番号運用に統一（`00`=運用、`01`=今回ケース）
- 反映:
  - `02_検証/00_ケース検証運用.md`
    - ケース分析 -> 知識側（01〜08）へ戻す手順を明記
  - `02_検証/portfolio/01/01_ケース_Blogカード画像_レンダリング挙動.md`
    - 今回ケースを個別ファイルとして固定
...
- 反映:
  - [00_ケース検証運用](../../02_検証/00_ケース検証運用.md)
    - ケース検証を `02_検証` に集約し、案件別フォルダで受ける運用へ更新
...
- 反映:
  - [02_ケース_Blog一覧_SP基準設計と余白責務](../../02_検証/portfolio/01/02_ケース_Blog一覧_SP基準設計と余白責務.md)
    - 認知アプローチ（分解手順）と結果を整理
  - [07_レイアウト](./07_レイアウト.md)
...
- 反映:
  - [01_ケース_2カラムとCTA・Flex配置判断](../../02_検証/portfolio/02/01_ケース_2カラムとCTA・Flex配置判断.md)
