...
この区別により、終了タグの書き方を確認したいのか、画像や動画の寸法・比率を確認したいのかを分けられる。画像の表示寸法は[画像を自然な比率で表示する](../11_メディア設計/01_画像を自然な比率で表示する.md)、動画は[動画を比率の枠へ収める](../11_メディア設計/06_動画を比率の枠へ収める.md)へ進む。
