  ...
  <ul class="staff__list">
    <li class="staff__item">
      <article class="staff-card">
        <h3 class="staff-card__title">スタッフ名</h3>
        <p>担当業務や紹介文が入ります。</p>
      </article>
    </li>
  </ul>
...
複数人の集まりだからul、一人ずつが項目だからliを使う。articleは、その人の紹介が独立した内容として読める場合の候補。名前の箇条書きだけなら、articleは必要ない。
...
画像の収め方は[バナーの枠と画像を分ける](../14_デザインパターンとCSS設計判断/05_バナーの枠と画像を分ける.md)、クリックできる範囲は[CTAとナビリンクの操作範囲を作る](../14_デザインパターンとCSS設計判断/07_CTAとナビリンクの操作範囲を作る.md)で扱う。
