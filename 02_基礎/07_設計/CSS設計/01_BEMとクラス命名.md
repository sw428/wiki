...
HTML要素自体の選択は[HTMLの意味と構造](../../01_HTML・CSS/04_HTMLの意味と構造/01_意味からHTML要素を選ぶ.md)、画像アイコンの囲み方は[装飾アイコンの実装](../../01_HTML・CSS/14_デザインパターンとCSS固定判断.md#装飾アイコンを疑似要素にするか実要素にするか)へ分担する。
