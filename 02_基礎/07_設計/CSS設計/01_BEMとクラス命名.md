...
HTML要素自体の選択は[HTMLの意味と構造](../../01_HTML・CSS/04_HTMLの意味と構造/01_意味からHTML要素を選ぶ.md)、画像アイコンの囲み方は[装飾アイコンとラベル](../../01_HTML・CSS/15_UI部品の実装判断/09_装飾アイコンとラベルを小さな部品として扱う.md)へ分担する。
