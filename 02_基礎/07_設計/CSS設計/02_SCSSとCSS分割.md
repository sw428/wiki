...
ここでの後勝ちは、出所、`!important`、カスケードレイヤーなど他の条件が同じ場合を指す。条件の全体は[カスケード全体の優先順位](../../01_HTML・CSS/06_CSSカスケードとDevToolsの見方/03_カスケード全体の優先順位.md)、画面での確認は[DevToolsの入口](../../01_HTML・CSS/06_CSSカスケードとDevToolsの見方/01_DevToolsで適用されたCSSを確認する.md)で扱う。
