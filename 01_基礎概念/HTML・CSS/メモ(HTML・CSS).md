...
- 実務判断で迷う内容は、必要に応じて `02_実践` 側へ運用ルールとして降ろす
...
- [01_CSS設計方針（BEM × レイアウト分離）](../../02_実践/ポートフォリオサイト/フィグマカンプ/01_CSS設計方針（BEM × レイアウト分離）.md)
  - コンポーネント核とページ側上書きの境界
  - 上書き可否の判断
  - サイズ差分をModifierで扱う方針
- [05_インラインと行の仕組み](./05_インラインと行の仕組み.md)
...
- 反映:
  - [01_ケース_Blogカード画像_レンダリング挙動](../../02_実践/ケース検証/フィグマカンプ/01_ケース_Blogカード画像_レンダリング挙動.md)
...
- 反映:
  - [00_HTML・CSS整理マップ](./00_HTML・CSS整理マップ.md)
    - `01〜08`（基礎概念）と `ケース検証`（個別検証）の運用モード分離を明記
    - ケース検証運用ファイルへの導線追加
  - [00_ケース検証運用（共通）](../../02_実践/ケース検証/00_ケース検証運用（共通）.md)
    - 命名ルール、置き場、記録テンプレを追加
...
- 反映:
  ...
  - `02_実践/ケース検証/フィグマカンプ/01_ケース_Blogカード画像_レンダリング挙動.md`
    - 今回ケースを個別ファイルとして固定
...
- 反映:
  - [00_ケース検証運用（共通）](../../02_実践/ケース検証/00_ケース検証運用（共通）.md)
    - ケース検証を `02_実践/ケース検証` に集約し、案件別フォルダで受ける運用へ更新
...
- 反映:
  - [02_ケース_Blog一覧_SP基準設計と余白責務](../../02_実践/ケース検証/フィグマカンプ/02_ケース_Blog一覧_SP基準設計と余白責務.md)
    - 認知アプローチ（分解手順）と結果を整理
  - [07_レイアウト](./07_レイアウト.md)
...
- 反映:
  - [01_ケース_マリンプラクティス2カラムとCTA・Flex配置判断](../../02_実践/ケース検証/マリンプラクティス/01_ケース_マリンプラクティス2カラムとCTA・Flex配置判断.md)
